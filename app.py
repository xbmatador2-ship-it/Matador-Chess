...
def undefended_pieces(
    ...
    """
    Retourne uniquement les pièces qui n'ont aucun
    défenseur ami réel.

    Une pièce est défendue si au moins une autre pièce
    du même camp contrôle sa case.

    Les pions comptent comme défenseurs.
    Une pièce attaquée mais protégée n'est donc PAS
    considérée comme non défendue.
    """
...
def detect_attacked_queen(
    ...
    """
    Retourne les cases des dames réellement vulnérables.

    Une dame simplement attaquée mais correctement protégée
    n'est PAS signalée.
    """
...
def detect_attacked_rooks(
    ...
    """
    Retourne les cases des tours réellement vulnérables.

    Une tour simplement attaquée mais correctement protégée
    n'est PAS signalée.
    """
